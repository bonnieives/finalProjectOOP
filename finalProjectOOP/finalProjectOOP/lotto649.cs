...
namespace finalProjectOOP
{
    public partial class lotto649 : Form
    {
        ...
        private void generateMax_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < randomNumberBox.Length; i++)
            {
                ...
                textBox649.Text += randomNumberBox[i].ToString();
                //textBox1.AppendText(randomNumberBox[i].ToString());
                textBox649.AppendText(Environment.NewLine);
            ...
            for (int i = 0; i < 7; i++)
            {
                ...
                // It will print into the label2 the concatenated numbers
                label649_7.Text += randomNumber[i].ToString() + " ";
            }

            // ---------------- BLOCK FOR FILES ----------------------------

            // Writing into the the file
            textOut.Write("649, " + date.ToString(@"yyyy'/'M'/'dd - hh:mm:ss tt, "));
        ...
        private void readFile649_Click(object sender, EventArgs e)
        {
        ...
        private void exit649_Click(object sender, EventArgs e)
        {
